...
public class MainActivity extends Activity {
    ...
    private void compute(Calculator.Operator operator) {
        String operandOneText = getOperandText(mOperandOneEditText);
        String operandTwoText = getOperandText(mOperandTwoEditText);

        if (operandOneText.isEmpty() || operandTwoText.isEmpty()) {
            mResultTextView.setText(getString(R.string.computationError));
            return;
        }
